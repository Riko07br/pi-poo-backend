...
public class ProjectUserResource {
    ...
    @GetMapping
    public ResponseEntity<Page<ProjectUserResponseDTO>> findAll(@PathVariable Long projectId, QueryParams queryParams) {
        Page<ProjectUserResponseDTO> projectUsers = projectUserService.findAll(projectId, queryParams);
